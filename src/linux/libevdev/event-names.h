...
static const char *const led_map[LED_MAX + 1] = {
    [LED_NUML] = "LED_NUML",         [LED_CAPSL] = "LED_CAPSL",
    [LED_SCROLLL] = "LED_SCROLLL",   [LED_COMPOSE] = "LED_COMPOSE",
    [LED_KANA] = "LED_KANA",         [LED_SLEEP] = "LED_SLEEP",
    [LED_SUSPEND] = "LED_SUSPEND",   [LED_MUTE] = "LED_MUTE",
    [LED_MISC] = "LED_MISC",         [LED_MAIL] = "LED_MAIL",
    [LED_CHARGING] = "LED_CHARGING", [LED_MAX] = "LED_MAX",
};
...
static const char *const msc_map[MSC_MAX + 1] = {
    [MSC_SERIAL] = "MSC_SERIAL",   [MSC_PULSELED] = "MSC_PULSELED",
    [MSC_GESTURE] = "MSC_GESTURE", [MSC_RAW] = "MSC_RAW",
    [MSC_SCAN] = "MSC_SCAN",       [MSC_TIMESTAMP] = "MSC_TIMESTAMP",
    [MSC_MAX] = "MSC_MAX",
};
...
static const char *const *const event_type_map[EV_MAX + 1] = {
    [EV_REL] = rel_map, [EV_ABS] = abs_map, [EV_KEY] = key_map,
    [EV_LED] = led_map, [EV_SND] = snd_map, [EV_MSC] = msc_map,
    [EV_SW] = sw_map,   [EV_FF] = ff_map,   [EV_SYN] = syn_map,
    [EV_REP] = rep_map,
};
...
static const struct name_entry code_names[] = {
    ...
    {.name = "KEY_AUTOPILOT_ENGAGE_TOGGLE",
     .value = KEY_AUTOPILOT_ENGAGE_TOGGLE},
    ...
    {.name = "KEY_LINK_PHONE", .value = KEY_LINK_PHONE},
