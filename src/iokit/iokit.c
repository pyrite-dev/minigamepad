...
void osxDeviceAddedCallback(void *context, IOReturn result, void *sender,
...
void osxDeviceRemovedCallback(void *context, IOReturn result, void *sender,
                              IOHIDDeviceRef device) {
  MG_UNUSED(context);
  MG_UNUSED(result);
  MG_UNUSED(sender);
...
mg_gamepads *mg_gamepads_fetch(void) {
  ...
  IOHIDManagerRegisterDeviceMatchingCallback(hidManager, osxDeviceAddedCallback,
                                             NULL);
  IOHIDManagerRegisterDeviceRemovalCallback(hidManager,
                                            osxDeviceRemovedCallback, NULL);
